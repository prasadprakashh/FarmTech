...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="list-group moblists">
                ...
                if (isset($_SESSION['phonenumber'])) {
                    ...
                    echo "<a href='../homepage.html' class='list-group-item list-group-item-action ' style='background-color:#292b2c;text-align:center;color:goldenrod'>Homepage</a>";
                } else {
                    echo "<a href='../login/BuyerLogin.php' class='list-group-item list-group-item-action ' style='background-color:#292b2c;text-align:center;color:goldenrod'>Login</a>";
                }
                ?>
            ...
            <div class="dropdown p-2 settings ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    if (isset($_SESSION['phonenumber'])) {
                        ...
                        echo "<a href='../homepage.html' class='dropdown-item ' style='padding-right:-20px;'>Homepage</a>";
                    } else {
                        echo "<a href='../login/BuyerLogin.php' class='dropdown-item ' style='padding-right:-20px;'>Login</a>";
                    }
                    ?>
                </div>
            </div>
   ...
   <br><br>
    ...
    <div class="container"> <img src="homeframe.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
